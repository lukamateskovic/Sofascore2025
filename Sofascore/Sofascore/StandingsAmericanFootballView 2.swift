...
final class StandingsAmericanFootballView: BaseView {
    ...
    override func addViews() {
        [positionLabel, teamLabel, playedLabel, wonLabel, drawLabel, lostLabel, pctLabel].forEach {
            addSubview($0)
        }
    ...
    func configure(position: String, team: String, played: String, won: String, draw: String, lost: String, pct: String, highlightPosition: Int)
    {
